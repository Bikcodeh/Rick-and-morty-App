...
const dataSearch: ApiResponse<Location> =
{
    info: {
        count: 27,
        pages: 2,
...
describe('Tests for <Locations />', () => {
    ...
    test('should display other data when search', async () => {
        ...
        await waitFor(() => new Promise((res) => setTimeout(res, 600)));
        expect(container.getElementsByClassName('cardLocation').length).toBe(1);
    })
});